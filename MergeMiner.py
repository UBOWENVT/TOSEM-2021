...
# Set the cutoff date when we start this project
CUT_OFF_DATE = "2020-03-19"
...
def git_log(path, logger):
    try:
        proc = subprocess.Popen("git log --all --before=" + CUT_OFF_DATE +
                                " --pretty='commit %H%nParent %P' > " + path,
